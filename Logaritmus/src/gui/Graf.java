...
import static gui.MainPanel.getMainPanelInst;
...
public class Graf extends JPanel implements MouseMotionListener
{
	...
	public void paint(Graphics g)
	{
		...
		int from = getMainPanelInst().getBeginPoint();
		int to = getMainPanelInst().getEndPoint();
	...
	private void centerScreen()
	{
		...
		{
			JScrollPane scrolPane = getMainPanelInst().getScrolPane();
